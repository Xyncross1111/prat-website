    ...
    return (
        <div className="w-full max-w-[1400px] mx-auto px-6 py-12 space-y-6">
            ...
            <SectionCard
                ...
                description="A step into a mystical utopia where imagination knows no bounds, and every realm unlocks a new dimension of creativity and wonder. From enchanted kingdoms and futuristic worlds to dreamscapes beyond comprehension, the festival will transport you into a universe where fantasy meets reality. This Pratishruti, embrace the extraordinary and journey through realms of fantasy and magic."
                image="/assets/image/arcadia_of_realms.webp"
            />
            <SectionCard
                title="UNDER 25 SUMMIT"
                description="
                Nagpur's Ramdeobaba University hosts the Under25 Summit, India’s ultimate youth festival for creators, entrepreneurs, and trendsetters. Meet top influencers, viral content creators, and industry icons, dive into interactive workshops, and network like never before. Whether you're a storyteller, entertainer, or future mogul, this is where your journey begins!"
            ...
            <SectionCard
                title="SPONSOR US"
                description="Showcasing talent and creativity, Pratishruti is more than just a festival.
