...
const allLeaderboardData = [
  { section: 'SECTION 01', score: 30, color: 'bg-slate-900', border: 'border-white' },
  { section: 'SECTION 02', score: 25, color: 'bg-slate-900', border: 'border-black' },
  { section: 'SECTION 03', score: 22, color: 'bg-slate-900', border: 'border-white' },
  { section: 'SECTION 04', score: 28, color: 'bg-slate-900', border: 'border-orange-600' },
  { section: 'SECTION 05', score: 32, color: 'bg-slate-900', border: 'border-blue-700' },
  { section: 'SECTION 06', score: 20, color: 'bg-slate-900', border: 'border-purple-500' },
  { section: 'SECTION 07', score: 35, color: 'bg-slate-900', border: 'border-green-500' },
  { section: 'SECTION 08', score: 27, color: 'bg-slate-900', border: 'border-pink-500' },
];
...
export default function Leaderboard() {
  const sortedData = [...allLeaderboardData].sort((a, b) => b.score - a.score);
